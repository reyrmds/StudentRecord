SELECT tbl_subject.code, tbl_subject.description, CASE WHEN tbl_record.grade IS NULL THEN 'INC' ELSE tbl_record.grade END as grade, CASE WHEN tbl_record.grade IS NULL THEN '0' ELSE tbl_subject.units END as units,SY+', '+CASE WHEN semester='1ST' THEN 'FIRST SEMESTER' ELSE 'SECOND SEMESTER' END as sysem  
