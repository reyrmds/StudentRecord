            ...
            <section class="content">
               ...
               <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    ...
                                    <div class="btn-group pull-right">
                                     	  <a onClick="window.location = '/sris/student_record_setup/A-B';">A-B</a>
                                          <a onClick="window.location = '/sris/student_record_setup/C-D';">C-D</a>
                                          <a onClick="window.location = '/sris/student_record_setup/E-F';">E-F</a>
                                          <a onClick="window.location = '/sris/student_record_setup/G-H';">G-H</a>
                                          <a onClick="window.location = '/sris/student_record_setup/I-J';">I-J</a>
                                          <a onClick="window.location = '/sris/student_record_setup/K-L';">K-L</a>
                                          <a onClick="window.location = '/sris/student_record_setup/M-N';">M-N</a>
                                          <a onClick="window.location = '/sris/student_record_setup/O-P';">O-P</a>
                                          <a onClick="window.location = '/sris/student_record_setup/Q-R';">Q-R</a>
                                          <a onClick="window.location = '/sris/student_record_setup/S-T';">S-T</a>
                                          <a onClick="window.location = '/sris/student_record_setup/U-V';">U-V</a>
                                          <a onClick="window.location = '/sris/student_record_setup/W-Z';">W-Z</a> 
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                        ...
                                        <c:forEach var="s" items="${studentlist}">
                                            <tr role="row" class="odd">
                                                ...
                                                <td align="center">
                                             	   	 <a onClick="window.location = '/sris/student_record_setup/view/'+${s.student_id};">
                        ...
                        <form:form action="/sris/student_record_setup/save" modelAttribute="student" method="post">
            	...
            	<form:form method="post" action="/sris/student_record_setup/update" modelAttribute="student" id="updateForm">
