...
<html>
<head>
    <title>Faculty Subjects | SRIS</title>
   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
            ...
            <section class="content-header">
				...
				<ol class="breadcrumb">
                    ...
                    <li class="active">Faculty Subjects</li>
                </ol>
            </section>
            <!--section ends-->
            <section class="content">
               ...
               <div class="row">
                            ...
                            <div class="portlet-body">
                                ...
                                <div id="sample_editable_1_wrapper" class="">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                        ...
                                        <c:forEach var="s" items="${facultysubjectlist}">
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">${s.faculty_name}</td>
                                                 <td class="sorting">${s.subject_desc}</td>
                                                <td align="center">
													<a faculty-subject-id="${s.facultysubject_id}" faculty-id="${s.faculty_id}" subject-id="${s.subject_id}" data-toggle="modal" data-target="#modalupdate">
														<i class="livicon" data-name="edit" data-size="25" data-loop="true" data-c="#EC971F" data-hc="#EC971F" ></i>
													</a>
													<a  faculty-subject-id="${s.facultysubject_id}" data-toggle="modal" data-target="#modaldelete">
				...
				<!--- ADD MODAL -->
            	<!--- responsive model -->
				<form:form action="faculty_subject_setup/save" modelAttribute="student" method="post">
                <div class="modal fade in" id="modaladd" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Faculty & Subject Information</h4>
                            </div>
												...
												<div class="col-md-9">											
													<form:select path="subject_id" id="subjectid" name="subjectid" class="form-control select2">
													  <c:forEach items="${getsubject}" var="s">
												            <form:option value="${s.subject_id}">${s.subject_code} ${s.subject_desc} ${s.subject_units} (units)</form:option>
												      </c:forEach>
													</form:select>
												</div>
											</div>
            	...
            	<!---EDIT MODAL -->
            	<form:form   method="post" action="faculty_subject_setup/update" modelAttribute="student" id="updateForm">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form:hidden path="facultysubject_id" name="facultysubjectid" id="facultysubjectid"  class="form-control"/>
	                            <div class="row">			                                                                  	    
									<div class="col-md-12">        
											<div class="form-group">
												<label for="e1" class="col-md-3  control-label">
												...
												<div class="col-md-9">											
													<form:select path="faculty_id" id="facultyid" name="facultyid" class="form-control select">
													  <c:forEach items="${getfaculty}" var="s">
												            <form:option value="${s.faculty_id}">${s.faculty_name}</form:option>
												      </c:forEach>
													</form:select>
                                ...
                                <div class="row">			                                                                  	    
									<div class="col-md-12">        
											<div class="form-group">
												...
												<div class="col-md-9">											
													<form:select path="subject_id" id="subjectid" name="subjectid" class="form-control select">
													  <c:forEach items="${getsubject}" var="s">
												            <form:option value="${s.subject_id}">${s.subject_code} ${s.subject_desc} ${s.subject_units} (units)</form:option>
												      </c:forEach>
													</form:select>
                ...
                <div class="modal fade in" id="modaldelete" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-body">
                                <p>Would you like to delete this faculty subject?</p>
                            </div>
                            <div class="modal-footer">
	...
	<script type="text/javascript">
	    ...
	    $('#modaldelete').on('show.bs.modal', function (e) {
        	  ...
        	  var facultysubjectid=$(opener).attr('faculty-subject-id');
        	  
        	  document.getElementById("deletebutton").onclick = function () {
      	    	window.location = 'faculty_subject_setup/delete/'+facultysubjectid;
      	   	  };
