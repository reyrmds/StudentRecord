   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
            ...
            <section class="content">
               ...
               <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                        ...
                                        <c:forEach var="s" items="${sectionlist}">
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">${s.section_section}</td>
                                                <td align="center">
													<a section-id="${s.section_id}" section-section="${s.section_section}" data-toggle="modal" data-target="#modalupdate">
														<i class="livicon" data-name="edit" data-size="25" data-loop="true" data-c="#EC971F" data-hc="#EC971F" ></i>
													</a>
													<a section-id="${s.section_id}" data-toggle="modal" data-target="#modaldelete">
				...
				<!--- ADD MODAL -->
				<form:form action="section_setup/save" modelAttribute="student" method="post">
                                ...
                                <div class="row"> 		
                                    <div class="col-md-12">                 
                                       <div class="form-group">
	                                        <label class="col-md-3 control-label" for="txtStudno">Section</label>
	                                        <div class="col-md-9">
	                                            <fieldset>
	                                            	<form:input path="section_section"  required="true" minlength="3" maxlength="3" name="sectionsection" id="sectionsection" type="text" class="form-control"/>
	                                       		</fieldset>
	                                        </div>									
                                       </div>
                                    </div>
            	...
            	<!---EDIT MODAL -->
            	<form:form  method="post" action="section_setup/update" modelAttribute="student" id="updateForm">
                <div class="modal fade in" id="modalupdate" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-md-12">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                <form:hidden path="section_id" name="sectionid" id="sectionid"  class="form-control"/>
                ...
                <div class="modal fade in" id="modaldelete" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-body">
                                <p>Would you like to delete this section ?</p>
                            </div>
                            <div class="modal-footer">
	...
	<script type="text/javascript">
	    ...
	    $('#modaldelete').on('show.bs.modal', function (e) {
        	  ...
        	  document.getElementById("deletebutton").onclick = function () {
      	    	window.location = 'section_setup/delete/'+sectionid;
      	   	  };
    ...
    <script>
         ...
         $('#modalupdate').on('show.bs.modal', function (e) {
          	  ...
          	  //we get details from attributes
          	  var sectionid=$(opener).attr('section-id');
          	  var sectionsection=$(opener).attr('section-section');


          	  //set what we got to our form
         	  $('#updateForm').find('[id="sectionid"]').val(sectionid);
              $('#updateForm').find('[id="sectionsection"]').val(sectionsection);
