...
<html>
<head>
    <title>Faculty  Professors | SRIS</title>
   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
            ...
            <section class="content-header">
				...
				<ol class="breadcrumb">
                    ...
                    <li class="active">Faculty Professors</li>
                </ol>
            </section>
            <!--section ends-->
            <section class="content">
               ...
               <div class="row">
                                        ...
                                        <c:forEach var="s" items="${facultylist}">
                                            <tr role="row" class="odd">
                                                ...
                                                <td align="center">
													...
													<a faculty-id="${s.faculty_id}" data-toggle="modal" data-target="#modaldelete">
				...
				<!--- ADD MODAL -->
            	<!--- responsive model -->
				<form:form action="faculty_setup/save" modelAttribute="student" method="post">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">                 
                                       <div class="form-group">
	                                        <label class="col-md-3 control-label" for="txtStudname">First Name</label>
	                                        <div class="col-md-9">                                         
												<form:input path="faculty_first" required="true" id="facultyfirst" name="facultyfirst" type="text" placeholder="Enter First Name" class="form-control"/>
	                                        </div>	
                                       </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">                 
                                       <div class="form-group">
	                                        <label class="col-md-3 control-label" for="txtStudname">Middle Initial</label>
	                                        <div class="col-md-9">                                         
												<form:input path="faculty_middle" id="facultymiddle" name="facultymiddle" type="text" placeholder="Enter Middle Initial" class="form-control"/>
	                                        </div>	
                                       </div>
                                    </div>
                                </div>   
                                ...
                                <div class="row">
                                    <div class="col-md-12">                 
                                       <div class="form-group">
	                                        <label class="col-md-3 control-label"  for="txtStudno">Last Name</label>
	                                        <div class="col-md-9">
	                                            <fieldset>
	                                            	<form:input path="faculty_last" required="true" name="facultylast" id="facultylast" type="text" class="form-control" placeholder="Enter Last Name"/>
	                                       		</fieldset>
	                                        </div>									
                                       </div>
                                    </div>
            	...
            	<!---EDIT MODAL -->
            	<form:form   method="post" action="faculty_setup/update" modelAttribute="student" id="updateForm">
                <div class="modal fade in" id="modalupdate" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-md-12">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                <form:hidden path="faculty_id" name="facultyid" id="facultyid"  class="form-control"/>
                                    ...
                                    <div class="col-md-12">                 
                                       <div class="form-group">
	                                        ...
	                                        <div class="col-md-9">
	                                            <fieldset>
	                                            	<form:input path="faculty_name" required="true" name="facultyname" id="facultyname" type="text" class="form-control" placeholder="Enter Last Name"/>
	                                       		</fieldset>
	                                        </div>									
                                       </div>
                                    </div>
                ...
                <div class="modal fade in" id="modaldelete" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-body">
                                <p>Would you like to delete this faculty ?</p>
                            </div>
                            <div class="modal-footer">
	...
	<script type="text/javascript">
	    ...
	    $('#modaldelete').on('show.bs.modal', function (e) {
        	  ...
        	  document.getElementById("deletebutton").onclick = function () {
      	    	window.location = 'faculty_setup/delete/'+facultyid;
      	   	  };
    ...
    <script>
         ...
         $('#modalupdate').on('show.bs.modal', function (e) {
         	  ...
         	  $('#updateForm').find('[id="facultyid"]').val(facultyid);
