               ...
               <div class="row">
				                    ...
				                    <div class="modal-dialog modal-md">
				                        <div class="modal-content">
				                            <div class="modal-body">
				                                <p>Would you like to restore these faculty record(s) ?</p>
				                            </div>
                ...
                <div class="modal fade in" id="modaldelete" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-body">
                                <p>Would you like to restore this faculty record ?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" data-dismiss="modal" class="btn">Cancel</button>
	...
	<script type="text/javascript">
	    ...
	    $('#modaldelete').on('show.bs.modal', function (e) {
        	  ...
        	  document.getElementById("deletebutton").onclick = function () {
      	    	window.location = 'faculty_util/restore/'+facultyid;
      	   	  };
	...
	<script type="text/javascript">
	    ...
	    $('#modaladd').on('show.bs.modal', function (e) {
        	  ...
        	  document.getElementById("deletebutton2").onclick = function () {
      	    	window.location = 'faculty_util/restoreall';
      	   	  };
