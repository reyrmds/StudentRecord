   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
            ...
            <section class="content-header">
                <!--section starts-->
                <h1>Faculty Subjects | Utilities</h1>
				<ol class="breadcrumb">
                    <li>
                        <a href="/sris/index">
                        ...
                        <div class="portlet box" style="background-color:#5583A1;font-color:#FFF">
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <button id="deletebutton2" class=" btn btn-custom" style="background-color:#5583A1" data-toggle="modal" data-href="#modaladd" href="#modaladd">
                                           	Restore All
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                        <thead style="background-color:#AE0000;" >
                                            <tr role="row" style="color: #fff;">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1">Subject Description</th>
                                        ...
                                        <c:forEach var="s" items="${facultysubjectlist}">
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">${s.faculty_name}</td>
                                                 <td class="sorting_1">${s.subject_desc}</td>
                    ...
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-body">
                                <p>Would you like to restore this faculty subject?</p>
                            </div>
	...
	<script type="text/javascript">
	    ...
	    $('#modaldelete').on('show.bs.modal', function (e) {
        	  ...
        	  document.getElementById("deletebutton").onclick = function () {
      	    	window.location = 'faculty_subject_util/restore/'+facultysubjectid;
      	   	  };
	...
	<script type="text/javascript">
	    ...
	    $('#modaladd').on('show.bs.modal', function (e) {
        	  ...
        	  document.getElementById("deletebutton2").onclick = function () {
      	    	window.location = 'faculty_subject_util/restoreall';
      	   	  };
