            ...
            <section class="content">
				 ...
				 <div class="row">
                    <div class="col-md-12">
                		...
                		<form:form  name="addForm" id="addForm" action="/sris/user/gradesheet/save" modelAttribute="student" method="post">               						
						...
						<form:form name="updateForm"  method="post" action="/sris/user/gradesheet/update" modelAttribute="student" id="updateForm">               
	...
	<script>
		...
		$(document).on("click", ".viewbtn", function () {
			var courseid=$(this).attr('course-id');
	     	...
	     	var semesterid=$(this).attr('semester-id');
	     	var facultysubjectid=$(this).attr('facultysubject-id');
	     	window.location = '/sris/user/gradesheet/view/'+courseid+'/'+sectionid+'/'+syid+'/'+semesterid+'/'+facultysubjectid;
	});	
