            ...
            <section class="content">
				 ...
				 <div class="row">
                    <div class="col-md-12">
                        ...
                        <form:form action="/sris/student-tor/search" modelAttribute="student" method="post">              					
                        ...
                        <form:form class="form-horizontal" method="post" action="/sris/student-tor/print" modelAttribute="student" id="searchForm">
                        <div class="portlet box" style="background-color:#5583A1;font-color:#FFF">
                            <div class="portlet-title">
                                <div class="caption">
