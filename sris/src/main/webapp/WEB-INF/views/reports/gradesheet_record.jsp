									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											...
											<div class="modal-body">
												<c:forEach var="s" items="${getgradesheet1}">
													<form:input path="course_id"  id="course_id" name="course_id" class="form-control" value="${s.course_id}"/>																	
					               					<form:input path="section_id"  id="sectionid" name="sectionid" class="form-control" value="${s.section_id}"/>
													<form:input path="sy_id" id="syid" name="syid" class="form-control" value="${s.sy_id}"/>
													<form:input path="semester_id" id="semesterid" name="semesterid" class="form-control" value="${s.semester_id}"/>
													<form:input path="facultysubject_id" id="facultysubjectid" name="facultysubjectid" class="form-control" value="${s.facultysubject_id}"/>
												</c:forEach>										
												<div class="row">
													<div class="col-md-12">                 
